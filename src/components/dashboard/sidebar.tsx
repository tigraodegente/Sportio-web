  ...
  return (
    <>
      ...
      >
        ...
        {/* GCoins Balance */}
        <div className="p-3">
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-800 to-blue-950 rounded-2xl p-4 text-white">
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-yellow-400/10 rounded-full blur-xl" />
