...
function HeroSection() {
  return (
    <section className="relative min-h-[100vh] flex items-center overflow-hidden bg-[#0a0f1a]">
      {/* Animated gradient orbs */}
      <div className="absolute inset-0">
        <div className="absolute top-[-20%] left-[-10%] h-[600px] w-[600px] rounded-full bg-emerald-600/20 blur-[120px] animate-float" />
        <div className="absolute bottom-[-20%] right-[-10%] h-[500px] w-[500px] rounded-full bg-amber-500/15 blur-[100px] animate-float" style={{ animationDelay: "1.5s" }} />
        <div className="absolute top-[40%] right-[20%] h-[300px] w-[300px] rounded-full bg-blue-500/10 blur-[80px] animate-float" style={{ animationDelay: "3s" }} />
      </div>
      ...
      {/* Floating sport icons background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[
          ...
          { icon: "🏊", top: "60%", right: "8%", delay: "0.5s", size: "text-2xl" },
          { icon: "🚴", bottom: "20%", right: "25%", delay: "1.5s", size: "text-2xl" },
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            {/* Badge */}
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-5 py-2.5 backdrop-blur-sm">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
              </span>
              <span className="text-sm font-medium text-emerald-300">Plataforma #1 de esportes no Brasil</span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-white leading-[1.1] mb-6">
              ...
              <span className="relative inline-block">
                <span className="relative z-10 text-gradient-hero">Esporte</span>
              </span>
              <br />
              em Renda
              <span className="inline-flex items-center ml-3">
                <span className="inline-flex h-12 w-12 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-400 to-amber-600 shadow-lg shadow-amber-500/30 animate-coin-bounce">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="/register"
                className="group relative inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-emerald-500 to-emerald-400 px-8 py-4 text-lg font-bold text-white shadow-2xl shadow-emerald-500/30 transition-all duration-300 hover:shadow-emerald-500/50 hover:-translate-y-1 overflow-hidden"
              >
              ...
              <a
                href="#como-funciona"
                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm px-8 py-4 text-lg font-semibold text-white transition-all duration-300 hover:bg-white/10 hover:border-white/20"
              >
...
function HowItWorksSection() {
  ...
  return (
    <section id="como-funciona" className="relative py-20 sm:py-28 bg-white overflow-hidden">
      ...
      <div className="absolute top-20 right-0 h-72 w-72 rounded-full bg-emerald-50 blur-3xl" />
      <div className="absolute bottom-20 left-0 h-72 w-72 rounded-full bg-amber-50 blur-3xl" />

      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 rounded-full bg-emerald-50 px-4 py-2 mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {steps.map((step, index) => (
            <div key={step.number} className="group relative">
              ...
              <div className="relative rounded-3xl border border-gray-100 bg-white p-8 shadow-sm transition-all duration-500 hover:shadow-xl hover:-translate-y-2 hover:border-gray-200">
                {/* Step number */}
                <span className="absolute -top-4 -right-2 text-7xl font-black text-gray-50 select-none group-hover:text-emerald-50 transition-colors">
                  {step.number}
                </span>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="group relative rounded-3xl border border-emerald-500/20 bg-gradient-to-br from-emerald-500/10 to-emerald-500/5 backdrop-blur-sm p-8 sm:p-10 transition-all duration-500 hover:border-emerald-500/40 hover:shadow-2xl hover:shadow-emerald-500/10">
            <div className="absolute top-6 right-6 h-20 w-20 rounded-full bg-emerald-500/10 blur-2xl transition-all group-hover:bg-emerald-500/20" />
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">GCoins Reais</h3>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/20 px-3 py-1 text-xs font-semibold text-emerald-300 mt-1">
            ...
            <p className="text-slate-300 mb-8 leading-relaxed">
              Ganhe dinheiro de verdade praticando esporte. Converta GCoins diretamente para sua conta via <span className="text-emerald-400 font-semibold">PIX instantâneo</span>.
            </p>
          ...
          <div className="group relative rounded-3xl border border-amber-500/20 bg-gradient-to-br from-amber-500/10 to-amber-500/5 backdrop-blur-sm p-8 sm:p-10 transition-all duration-500 hover:border-amber-500/40 hover:shadow-2xl hover:shadow-amber-500/10">
            <div className="absolute top-6 right-6 h-20 w-20 rounded-full bg-amber-500/10 blur-2xl transition-all group-hover:bg-amber-500/20" />
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">GCoins Gamificação</h3>
                <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-500/20 px-3 py-1 text-xs font-semibold text-amber-300 mt-1">
...
function SportsGridSection() {
  ...
  return (
    <section className="relative py-20 sm:py-28 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      <div className="absolute top-0 right-0 h-96 w-96 rounded-full bg-emerald-50 blur-3xl opacity-50" />
          ...
          {SPORTS.map((sport) => {
            ...
            return (
              <div
                key={sport.id}
                className={cn(
                  "group relative rounded-2xl border bg-white p-5 sm:p-6 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl cursor-pointer",
                  colors.border,
          ...
          {USER_TYPES.map((userType) => {
            ...
            return (
              <a
                key={userType.id}
                href={userType.href}
                className="group relative rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 transition-all duration-500 hover:bg-white/10 hover:border-white/20 hover:-translate-y-2 hover:shadow-2xl"
              >
...
function TestimonialsSection() {
  ...
  return (
    <section className="relative py-20 sm:py-28 bg-white overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 via-blue-500 to-purple-500" />
      <div className="absolute bottom-20 right-0 h-72 w-72 rounded-full bg-emerald-50 blur-3xl" />

      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 rounded-full bg-amber-50 px-4 py-2 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div
              key={t.author}
              className="group relative rounded-3xl border border-gray-100 bg-white p-8 shadow-sm transition-all duration-500 hover:shadow-xl hover:-translate-y-2"
            >
              {/* Stars */}
              ...
              <div className="flex items-center gap-4">
                <div className={cn("flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br text-lg font-bold text-white", t.color)}>
...
function CTASection() {
  return (
    <section className="relative py-20 sm:py-28 bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-500 overflow-hidden">
      {/* Background pattern */}
      <div className="absolute inset-0">
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a
          href="/register"
          className="group inline-flex items-center gap-3 rounded-2xl bg-white px-10 py-5 text-lg font-bold text-emerald-600 shadow-2xl transition-all duration-300 hover:shadow-white/30 hover:-translate-y-1"
        >
          ...
          {faqs.map((faq) => (
            <details key={faq.question} className="group rounded-2xl border border-gray-200 bg-white transition-all duration-300 hover:shadow-md open:shadow-lg open:border-emerald-200">
              <summary className="flex cursor-pointer items-center justify-between p-6 [&::-webkit-details-marker]:hidden">
                <span className="pr-6 text-lg font-bold text-gray-900 group-open:text-emerald-600 transition-colors">
                  {faq.question}
                </span>
