        ...
        <div className="bg-gradient-to-b from-slate-50 to-white p-4 border-b border-slate-100">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center shadow-sm shadow-emerald-500/25">
                <MessageSquareText className="w-4 h-4 text-white" />
              </div>
              <h2 className="text-lg font-bold text-slate-900 tracking-tight">Mensagens</h2>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="text-xs font-semibold text-emerald-600 bg-emerald-50 rounded-full px-2.5 py-0.5 border border-emerald-100">
        ...
        <div className="flex-1 flex flex-col bg-gradient-to-b from-slate-50/30 to-white">
          ...
          <div className="h-16 flex items-center justify-between px-5 border-b border-slate-100 bg-white/80 backdrop-blur-sm">
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                <Avatar name={selectedConversation?.name} size="sm" className="ring-2 ring-emerald-100" />
              ...
              >
                <div
                  className={cn(
                    ...
                    msg.senderId === "me"
                      ? "bg-gradient-to-br from-emerald-600 to-emerald-500 text-white rounded-br-md shadow-md shadow-emerald-500/20 hover:shadow-lg hover:shadow-emerald-500/25"
          ...
          <div className="p-3 sm:p-4 border-t border-slate-100 bg-white/80 backdrop-blur-sm">
            <div className="flex items-center gap-2 bg-slate-50 rounded-2xl p-1.5 border border-slate-200/80 shadow-sm shadow-slate-200/30 focus-within:border-emerald-300 focus-within:shadow-md focus-within:shadow-emerald-500/5 transition-all duration-300">
              <div className="flex items-center gap-0.5 pl-1">
                <button className="p-2 rounded-xl text-slate-400 hover:text-emerald-600 hover:bg-white transition-all duration-200">
              ...
              <Button
                ...
                className={cn(
                  ...
                  messageInput.trim()
                    ? "bg-gradient-to-r from-emerald-600 to-emerald-500 shadow-md shadow-emerald-500/25 hover:shadow-lg hover:shadow-emerald-500/30 hover:scale-105"
        ...
        <div className="hidden sm:flex flex-1 items-center justify-center bg-gradient-to-br from-slate-50 via-white to-emerald-50/30">
          <div className="text-center max-w-xs">
            ...
            <div className="relative w-24 h-24 mx-auto mb-6">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-emerald-200/40 to-emerald-100/20 rotate-6 scale-110" />
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-emerald-100/50 to-emerald-50/30 -rotate-3 scale-105" />
              <div className="relative w-24 h-24 rounded-2xl bg-gradient-to-br from-emerald-100 to-emerald-50 flex items-center justify-center shadow-sm">
                <MessageSquareText className="w-11 h-11 text-emerald-500" />
              </div>
            </div>
