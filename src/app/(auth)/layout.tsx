  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-emerald-700 to-slate-900 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="absolute bottom-32 right-24 w-10 h-10 border border-emerald-300/15 rounded-full" />
        ...
        <div className="absolute top-40 left-1/3 w-3 h-3 bg-emerald-300/20 rounded-full" />
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 text-emerald-200 text-sm mb-6">
          ...
          <div className="mt-8 grid grid-cols-2 gap-3">
            {[
              ...
              <div key={stat.label} className="bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/15 shadow-lg shadow-black/5 hover:bg-white/15 transition-colors duration-300">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-400/20 mb-2">
